...
#th
set_property PACKAGE_PIN V17 [get_ports {th[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {th[0]}]
set_property PACKAGE_PIN V16 [get_ports {th[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {th[1]}]
set_property PACKAGE_PIN W16 [get_ports {th[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {th[2]}]
set_property PACKAGE_PIN W17 [get_ports {th[3]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {th[3]}]
set_property PACKAGE_PIN W15 [get_ports {th[4]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {th[4]}]
set_property PACKAGE_PIN V15 [get_ports {th[5]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {th[5]}]
set_property PACKAGE_PIN W14 [get_ports {th[6]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {th[6]}]
set_property PACKAGE_PIN W13 [get_ports {th[7]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {th[7]}]

#mode
set_property PACKAGE_PIN G15 [get_ports {mode[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {mode[0]}]
set_property PACKAGE_PIN P15 [get_ports {mode[1]}]			
